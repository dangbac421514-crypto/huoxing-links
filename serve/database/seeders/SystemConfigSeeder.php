...
final class SystemConfigSeeder extends Seeder
{
    public function run(): void
    {
        $rows = [
            ...
            ['slug' => 'web_site_customer_service', 'value' => '/image/web-qr.png', 'desc' => '客服二维码'],
            ['slug' => 'web_site_logo', 'value' => '/image/toplogo.png', 'desc' => '网站 logo 浅色'],
            ['slug' => 'web_site_title', 'value' => '蚂蚁快链-智慧引流工具', 'desc' => '网站名称'],
